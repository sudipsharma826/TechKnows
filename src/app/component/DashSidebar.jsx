...
import { HiAcademicCap, HiBookmark, HiInbox, HiPencil, HiPencilAlt } from 'react-icons/hi';
...
export function DashSideBar() {
  ...
  return (
    <Sidebar aria-label="Sidebar with logo branding example" className='w-full md:w-56'>
      {/* Sidebar Logo */}
      <div className="px-4 py-2 flex items-center mt-8.5 sm:mt-0">
      ...
      <Sidebar.Items>
        <Sidebar.ItemGroup className='flex flex-col gap-1 '>
          ...
          {['superadmin', 'admin'].includes(currentUser?.role) && (
            ...
            <Link href="/page/dashboard?tab=getpost" passHref>
              <Sidebar.Item icon={HiBookmark}>Posts</Sidebar.Item>
            </Link>
